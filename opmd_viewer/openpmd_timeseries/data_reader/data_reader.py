...
class DataReader( object ):
    ...
    def read_field_cartesian( self, filename, field_path, axis_labels,
        ...
        field_path : string
           The relative path to the requested field, from the openPMD meshes
           path (e.g. 'rho', 'E/z', 'B/x')
        ...
        A tuple with
           ...
           (contains information about the grid; see corresponding docstring)
        """
        return self.reader_module.read_field_cartesian(
            filename, field_path, axis_labels, slicing, slicing_dir)

    def read_field_circ( self, filename, field_path, slicing, slicing_dir, m=0,
                         theta=0. ):
        """
        Extract a given field from an HDF5 file in the openPMD format,
        ...
        return self.reader_module.read_field_circ(
            filename, field_path, slicing, slicing_dir, m, theta )
